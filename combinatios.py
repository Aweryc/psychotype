...
def get_desc_type(main_label):
    if main_label == 'Искатель':
        return f'Твой психотип: <b>{main_label}</b>\n' \
               ...
               f'Исследователь - это один из ключевых игроков команды любого проекта и бизнеса.' \
               f'Работодатели постоянно находятся в поисках талантливых Исследователей.' \
               f'Среднерыночная зарплата профессий для данного психотипа начинается от 100.000 рублей.' \
               f'У нас для тебя уникальное предложение: Поделись ссылкой на твой аккаунт в социальной' \
               f'сети и получи шанс присоединиться к команде мечты! На данный момент в команде моих создателей' \
               f'открыто более 12 вакансий, которые подходят под твой психотип. Мы будем рады позвать' \
               f'тебя на собеседование и познакомиться с тобой! '

    elif main_label == 'Созидатель':
        return f'Твой психотип: <b>{main_label}</b>\n' \
               ...
               f'Создатель - это один из ключевых игроков команды любого проекта и бизнеса.' \
               ...
               f'На данный момент в команде моих создателей открыто более 14 вакансий, которые подходят под твой психотип.' \
        ...
        return f'Твой психотип: <b>{main_label}</b>\n' \
               ...
               f'Стратег - это один из ключевых игроков команды любого проекта и бизнеса.' \
               f'Работодатели постоянно находятся в поисках талантливых Стратегов. Среднерыночная зарплата профессий' \
               f'для данного психотипа начинается от 100.000 рублей.\n' \
               f'У нас для тебя уникальное предложение:\n' \
               f'Поделись ссылкой на твой аккаунт в социальной сети и получи шанс присоединиться к команде мечты!' \
               f'На данный момент в команде моих создателей открыто более 11 вакансий,' \
        ...
        return f'Твой психотип: <b>{main_label}</b>\n' \
               ...
               f'Коммуникатор - это один из ключевых игроков команды любого проекта и бизнеса.' \
               f'Работодатели постоянно находятся в поисках талантливых Коммуникаторов.' \
               f'Среднерыночная зарплата профессий для данного психотипа начинается от 100.000 рублей.\n' \
               f'У нас для тебя уникальное предложение:\n' \
               f'Поделись ссылкой на твой аккаунт в социальной сети и получи шанс присоединиться к команде мечты!' \
               f'На данный момент в команде моих создателей открыто более 13 вакансий, которые подходят под твой психотип.' \
               f'Мы будем рады позвать тебя на собеседование и познакомиться с тобой!'
